...
public class Startup
{
    ...
    void ConfigureMediator(IServiceCollection services)
    {
        ...
        mediatorBuilder.RegisterHandlers(assembly => assembly.DefinedTypes.Where(t =>
            t.Name != nameof(MultiRequestsHandler)), TestUtilAssembly.Assembly, typeof(Startup).Assembly);
